...
if (d=='Lunch & Dinner' && c<100)
  {
  alert("Minimum Number of pax allowed in Lunch & Dinner is 100");
  return false;
  }
...
<SCRIPT language=Javascript>
 ...
 <div class="row-top" style="margin-bottom: 20px;">
	<div class="main">
		<div class="wrapper">
			<h1><a href="">Princess Park<br><span style="font-family: arial; font-size: 15px;"></span></a></h1>
		</div>
	</div>
</div>
...
if($ewewe>=14){
	...
	Location: <br>
	<select name="loc">
	<option value=".10">Outside Bacolod</option>
